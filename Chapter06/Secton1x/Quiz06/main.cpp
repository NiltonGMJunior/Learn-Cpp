...
int main()
{
    std::mt19937 mersenne(static_cast<int>(std::time(nullptr))); // Initializes a Mersenne twister with a random seed based on the clock
    ...
    // shuffleDeck(deck, mersenne); // Suffles the deck with the mersenne seed
